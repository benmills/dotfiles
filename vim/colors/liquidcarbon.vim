...
hi  LineNr          guifg=#404040   guibg=bg        gui=NONE
...
hi  NonText         guifg=#3b3b3b   guibg=bg        gui=NONE
...
hi  SpecialKey      guifg=#3b3b3b   guibg=NONE      gui=NONE
hi  SpellBad        guisp=#ee2c2c   gui=undercurl
hi  SpellCap        guisp=#0000ff   gui=undercurl
hi  SpellLocal      guisp=#008b8b   gui=undercurl
hi  SpellRare       guisp=#ff00ff   gui=undercurl
hi  StatusLine      guifg=#ddeeff   guibg=#333536   gui=NONE
hi  StatusLineNC    guifg=#646464   guibg=#28292a   gui=NONE
hi  TabLine         guifg=bg        guibg=#445566   gui=none
hi  TabLineFill     guifg=fg        guibg=bg        gui=bold
hi  TabLineSel      guifg=fg        guibg=bg        gui=bold
hi  Title           guifg=#009acd   guibg=bg        gui=bold
hi  VertSplit       guifg=#333536   guibg=bg        gui=NONE
