...
hi DiffText                   guibg=#bfdfff                  ctermbg=6     cterm=NONE
hi NonText      guifg=bg			guibg=bg 			ctermfg=darkblue
hi SpecialKey   guifg=grey50  guibg=grey86  ctermfg=darkblue
hi LineNr       guifg=bg 			guibg=bg          ctermfg=darkblue
hi Search                     guibg=#fff999
hi StatusLine   guifg=#FFFFFF      guibg=grey40 ctermfg=bg       ctermbg=black cterm=NONE
hi StatusLineNC guifg=#FFFFFF      guibg=grey40  ctermfg=bg       ctermbg=black cterm=NONE
hi Visual       guifg=fg      guibg=#ccccdd 
hi VisualNOS    guifg=bg      guibg=#ccccdd 
hi VertSplit         guifg=#FFFFFF    guibg=NONE    cterm=NONE 
