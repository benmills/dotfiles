...
"  call Dfunc("s:ColorschemeLoaded()")
  ...
  hi HL_RltvNmbr_Minus guifg=#3D3D3D     guibg=black       gui=NONE      ctermfg=darkgray    ctermbg=NONE        cterm=NONE
  hi HL_RltvNmbr_Positive guifg=#3D3D3D     guibg=black       gui=NONE      ctermfg=darkgray    ctermbg=NONE        cterm=NONE
